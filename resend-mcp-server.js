...
// ─── API Helper (Tvůj původní chytrý wrapper) ─────────────────
...
const TOOLS = [
  ...
  // ─── BROADCASTS, CONTACTS, SEGMENTS, DOMAINS, LOGS ───
...
// ─── FUNKCE PRO VYTVOŘENÍ SERVERU (Zabrání padání při reconnectu) ───
...
app.get("/sse", async (req, res) => {
  console.log("✅ Nové připojení k SSE");
  try {
